...
public class Dashboard extends JFrame {
	...
	public static void courseData(){
	        ...
	        try {
		           ...
		           String query = "select * from course_management_system.Course";
...
public static void tutorsData() {
    ...
    try {
           ...
           String query2 = "select * from course_management_system.teacher";
...
public static void dataStudent() {
    ...
    try {
           ...
           String q = "select * from course_management_system.student";
...
public static void studentSearchEnter(String student){
    ...
    try {
           Connection con = DriverManager.getConnection(url, baseUsername, basePassword);
           Statement stmt = con.createStatement();
           String query = "select * from course_management_system.student WHERE FirstName ='"+enteredStudent+"'";
...
public static void courseSearchEnter(String course) {
    ...
    try {
           Connection con = DriverManager.getConnection(url, baseUsername, basePassword);
           Statement stmt = con.createStatement();
           String query = "select * from course_management_system.Course WHERE Course_Name ='"+enteredText+"'";
           ResultSet rs = stmt.executeQuery(query);   
           while(rs.next()){
        	   String id = rs.getString(1);
        	   String course_name = rs.getString(2);
...
public static void tutorSearchEnter(String tutor) {
    ...
    try {
           Connection con2 = DriverManager.getConnection(url, baseUsername, basePassword);
           Statement stmt2 = con2.createStatement();
           String query2 = "select * from course_management_system.teacher where First_Name='"+teacher+"'";
           ResultSet rs2 = stmt2.executeQuery(query2);
           while(rs2.next()){
        	   String id = rs2.getString(1);
        	   String firstName = rs2.getString(2);
...
public static void displayDashboard(){
    ...
    try {
           Connection con2 = DriverManager.getConnection(url, baseUsername, basePassword);
           Statement stmt2 = con2.createStatement();
           String query2 = "select * from course_management_system.activity";
           ResultSet rs2 = stmt2.executeQuery(query2);
           while(rs2.next()){
        	   String id = rs2.getString(1);
...
public static String TotalColumns(String tableName) {
    ...
    try {
        ...
        Statement stmt = con.createStatement();
        String data = "SELECT * FROM course_management_system." + tableName;
	...
	public Dashboard() {
		...
		coursesBtn.setBounds(34, 232, 158, 46);
		...
		tutorBtn.setBounds(34, 316, 158, 46);
		panel.add(tutorBtn);
		...
		studentBtn.setBounds(34, 403, 158, 46);
		...
		settingBtn.setBounds(34, 492, 158, 46);
		...
		panel_1.setBackground(UIManager.getColor("Separator.foreground"));
		...
		totalStudent.setBounds(52, 53, 99, 40);
		...
		panel_9_1.setBackground(SystemColor.activeCaptionBorder);
		...
		panel_9_2.setBackground(SystemColor.activeCaptionBorder);
		...
		btnDeleteCourse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DeleteCourse cd = new DeleteCourse();
				cd.setVisible(true);
...
;				ta.setVisible(true);
		...
		btnUpdateTutors.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EditingTutor et = new EditingTutor();
				et.setVisible(true);
		...
		btnDeleteTutors.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TutorDelete td = new TutorDelete();
				td.setVisible(true);
		...
		btnDeleteStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				StudentDelete dts = new StudentDelete();
				dts.setVisible(true);
		...
		lblSetting.setBounds(12, 21, 178, 24);
...
//				String userMail = Login.mail();
		...
		JLabel lblGuidelinesForStudents = new JLabel("Guidelines for Students");
		lblGuidelinesForStudents.setBounds(12, 459, 193, 15);
		panel_7.add(lblGuidelinesForStudents);
		
		JLabel lblReportIfAny = new JLabel("Report  techinal issues");
		lblReportIfAny.setBounds(12, 486, 193, 15);
		...
		lblIfAnyTechinal.setBounds(38, 513, 244, 15);
		...
		passChangeEmail.setBounds(172, 360, 152, 30);
		...
		panel_8.setBounds(260, 12, 838, 70);
		contentPane.add(panel_8);
		panel_8.setLayout(null);
		
		JLabel lblAdminDashboard = new JLabel("Admin Dashboard");
		lblAdminDashboard.setForeground(UIManager.getColor("Button.foreground"));
		lblAdminDashboard.setBackground(SystemColor.activeCaption);
		lblAdminDashboard.setHorizontalAlignment(SwingConstants.CENTER);
		lblAdminDashboard.setFont(new Font("Dialog", Font.BOLD, 20));
		lblAdminDashboard.setBounds(12, 12, 797, 60);
